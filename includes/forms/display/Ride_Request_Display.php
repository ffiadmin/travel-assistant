...
*/
	...
	public function getWhere() {
		return "<input autocomplete=\"off\" class=\"rounded-left validate[required]\" id=\"where-city\" name=\"where-city\" placeholder=\"Destination city\" type=\"text\" value=\"" . htmlentities($this->data ? $this->data[0]->City : "") . "\">
...
/**
 * Output a prefilled form element containing the "amount of gas money to
 * share" form element for section two of this form.
 * 
 * @access public
 * @return string   A form item prefilled with a value from either the database or a default value
 * @since  v1.0 Dev
