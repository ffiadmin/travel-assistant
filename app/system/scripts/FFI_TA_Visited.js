...
(function($) {
	...
	//Allow the user to override default options
		$.extend($.fn.FFI_TA_Visited.defaults, options);
	...
	//Set the zoom
		...
		//Google Maps instantiation and configuration
			...
			var map = new google.maps.Map($(this).get(0), {
				...
				zoom              : $.fn.FFI_TA_Visited.defaults.zoom
			});
		...
		//Make the AJAX request to the server
			$.ajax({
				dataType : 'json',
				url      : $.fn.FFI_TA_Visited.defaults.processURL,
				type     : 'GET',
...
*/
	...
	$.fn.FFI_TA_Visited.defaults = {
		...
		'originState' : 'pa',
		'processURL'  : document.location.href.substring(0, document.location.href.indexOf('travel-assistant')) + 'wp-content/plugins/travel-assistant/app/system/ajax/visited.php',
		'zoom'        : 4
	};
})(jQuery);